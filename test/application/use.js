...
describe('app.use(fn)', () => {
  ...
  it.skip('should compose mixed middleware', async () => {
  ...
  it.skip('should accept both generator and function middleware', () => {
    process.once('deprecation', () => {}) // silence deprecation message
    const app = new Koa()
  ...
  it.skip('should output deprecation message for generator functions', done => {
